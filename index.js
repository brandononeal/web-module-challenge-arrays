...
function getRandomFlavors(arr1, arr2, arr3, arr4){
    // creates a buffer array to hold random flavors
    let buffer = [], start;
    // combines arrays 1-4 into a single array
    let masterList = arr1.concat(arr2,arr3,arr4)

    // pushes 31 random flavors from masterList to buffer
    for (let i=0 ; i < 31; i++){
        buffer.push(masterList[Math.floor(Math.random() * 100)])
    }
